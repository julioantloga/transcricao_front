/* =============================================================================
   FILE: src/App.jsx
   RESPONSABILIDADE: Definição de rotas da aplicação
   ============================================================================= */
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/settings/interview_types/:id"
          element={
            <ProtectedRoute>
              <WithHeader>
                <EditInterviewType />
        ...
        <Route
          path="/settings/interview_scripts"
          element={
            <ProtectedRoute>
              <WithHeader>
                <InterviewScripts />
        ...
        <Route
          path="/settings/interview_scripts/:id"
          element={
            <ProtectedRoute>
              <WithHeader>
                <EditInterviewScript />
...
/* =============================================================================
   FILE: src/main.jsx
   RESPONSABILIDADE: Bootstrap da aplicação React
   ============================================================================= */
